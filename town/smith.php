...
echo '<div class="row">';
echo '<div class="col-xs-4"><button class="btn-main" disabled>Создать</button></div>';
echo '<div class="col-xs-4" style="padding: 0 1px"><button class="btn-main" disabled>Чинить</button></div>';
echo '<div class="col-xs-4"><button class="btn-main" disabled>Задания</button></div>';
echo '</div>';

echo '<div id="things_area" class="row"></div>';
